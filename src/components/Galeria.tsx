...
export function Galeria() {
  return (
    <RevealSection id="galeria" className="relative overflow-hidden bg-bordo-escuro py-24 md:py-32">
      <div
      ...
      <div className="relative mx-auto grid max-w-6xl grid-cols-1 items-center gap-12 px-6 md:grid-cols-2">
        <RevealItem>
          ...
          <p className="mt-5 max-w-md text-sm text-branco/70 md:text-base">
          ...
          <span className="mt-6 inline-flex items-center gap-2 rounded-full border border-luz-amarela/30 bg-branco/5 px-4 py-1.5 text-[11px] font-semibold uppercase tracking-[0.2em] text-luz-amarela">
