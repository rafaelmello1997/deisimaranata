  ...
  return (
    <RevealSection className="relative overflow-hidden bg-tinta py-24 md:py-32">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -left-32 top-1/2 h-96 w-96 -translate-y-1/2 rounded-full bg-amarelo/10 blur-[120px]" />
      </div>
      ...
      <div className="relative mx-auto max-w-4xl px-6 text-center">
        ...
        <RevealItem delay={0.2} className="mt-10 flex flex-wrap items-center justify-center gap-4">
          <div className="rounded-2xl border border-branco/15 bg-branco/[0.04] px-6 py-4">
            <span className="font-display block text-3xl font-extrabold text-amarelo">+82%</span>
            <span className="mt-1 block text-[11px] uppercase tracking-[0.16em] text-branco/60">
              Aprovação em Guaíba
            </span>
          </div>
          <div className="rounded-2xl border border-branco/15 bg-branco/[0.04] px-6 py-4">
            <span className="font-display block text-3xl font-extrabold text-amarelo">2x</span>
            <span className="mt-1 block text-[11px] uppercase tracking-[0.16em] text-branco/60">
