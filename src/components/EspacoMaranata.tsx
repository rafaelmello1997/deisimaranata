      ...
      <div className="relative mx-auto grid max-w-6xl grid-cols-1 items-center gap-12 px-6 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="text-center lg:text-left">
          ...
          <RevealItem delay={0.1} className="mt-8 space-y-4 text-[15px] leading-relaxed text-branco/85 md:text-base">
            <p>
              ...
              gestão que é referência. O Marcelo provou que é possível
              ampliar hospitais, abrir leitos e expandir as ESFs com
              eficiência.
            </p>
            <p>
              Nossa parceria vai além da vida pessoal, é uma união de
              propósitos. Enquanto ele foca na macrogestão e no
              desenvolvimento econômico, eu garanto que o olhar humano e o
              cuidado com as pessoas sejam a prioridade absoluta. Somos a
              prova de que a gestão técnica e o coração podem, sim, caminhar
              juntos.
            </p>
          </RevealItem>
          ...
          <RevealItem delay={0.2} className="mt-10 flex flex-wrap items-center justify-center gap-4 lg:justify-start">
            <div className="rounded-2xl border border-branco/15 bg-branco/[0.06] px-6 py-4">
              <span className="font-display block text-3xl font-extrabold text-luz-amarela">+82%</span>
              <span className="mt-1 block text-[11px] uppercase tracking-[0.16em] text-branco/60">
                Aprovação em Guaíba
              </span>
            </div>
            <div className="rounded-2xl border border-branco/15 bg-branco/[0.06] px-6 py-4">
              <span className="font-display block text-3xl font-extrabold text-luz-amarela">2x</span>
              <span className="mt-1 block text-[11px] uppercase tracking-[0.16em] text-branco/60">
        ...
        <RevealItem delay={0.15} className="grid grid-cols-2 gap-4">
          <div className="col-span-2 overflow-hidden rounded-2xl border border-branco/15 shadow-[0_20px_50px_rgba(0,0,0,0.3)]">
            <img
              src="/assets/maranata/maranata-1.jpg"
          ...
          <div className="col-span-2 overflow-hidden rounded-2xl border border-branco/15 shadow-[0_20px_50px_rgba(0,0,0,0.3)]">
            <img
              src="/assets/maranata/maranata-2.jpg"
