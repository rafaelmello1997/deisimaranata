  ...
  return (
    <RevealSection className="relative overflow-hidden bg-branco py-24 md:py-32">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute left-1/2 top-0 h-96 w-96 -translate-x-1/2 rounded-full bg-bordo/10 blur-[110px]" />
      </div>
      ...
      <div className="relative mx-auto flex max-w-6xl flex-col items-center px-6 text-center">
        ...
        <RevealItem delay={0.15} className="relative mt-12 w-full max-w-xs sm:max-w-sm">
          <div className="absolute -inset-5 rounded-[2.75rem] bg-bordo/15 blur-2xl" />
          <div className="relative overflow-hidden rounded-[2rem] border border-tinta/15 bg-tinta shadow-[0_30px_80px_rgba(0,0,0,0.45)]">
            <video
